...
abstract class Model {
  ...
  String? stringNullFromJson(dynamic json, String attribute, {String? defaultValue}) {
    try {
      if (json == null || json[attribute] == null) {
        return defaultValue;
      } else {
  ...
  double? doubleNullFromJson(dynamic json, String attribute, {int? fix, double? defaultValue}) {
    try {
      if (json == null || json[attribute] == null) {
        return defaultValue;
      } else if (fix != null) {
